...
namespace Resources {
	...
	class Resource {
		...
		static readonly Resource coffee = new Resource("coffee",
			...
			, 6, Color.DarkRed); // 63 prov in vicky 2
		...
		static readonly Resource gold = new Resource("gold",
			...
			, 0, Color.Yellow); // 3503 t/yr in 2018; 1 prov in vicky 2 = precious metal
...
/* COLORS
Black		FORBIDDEN
White		cotton ivory marble
Grey		salt silver
DarkGrey	coal pepper
Red			iron
DarkRed		coffee furs
Yellow		gold sulfur
DarkYellow	cocoa wheat
Green		tea sugar
DarkGreen	hemp opium tobacco
Cyan		copper tropical_wood
DarkCyan	fish truffle
Blue		woad gems
DarkBlue	rubber
Magenta		incense silk
DarkMagenta	cinnamon wine
